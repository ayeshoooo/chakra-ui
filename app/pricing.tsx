...
export default function pricing() {
  return (
    <Box maxW={'950px'} mx={{base:'20px',lg:'auto'}}  mt={'-150px'} bg={'white'} borderRadius={'16px'} overflow={'hidden'} boxShadow={'0px 20px 25px -5px rgba(0, 0, 0, 0.1),0px 10px -5px rgba(0,0,0,0.04);'}>
